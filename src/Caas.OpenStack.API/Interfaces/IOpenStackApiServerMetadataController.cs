...
namespace Caas.OpenStack.API.Interfaces
{
	...
	{
		/// <summary>	Gets server metadata.
		/// 			OpenStack API equivalent - >  GET/v2/​{tenant_id}​/servers/​{server_id}​/metadata </summary>
		...
		/// <summary>	Creates or update server metadata
		/// 			OpenStack API equivalent - > PUT/v2/​{tenant_id}​/servers/​{server_id}​/metadata. </summary>
		/// <param name="tenantId">	Identifier for the tenant. </param>
		/// <param name="serverId">	Identifier for the server. </param>
		...
		/// <summary>	Updates the server metadata items
		/// 			OpenStack API equivalent - > POST /v2/​{tenant_id}​/servers/​{server_id}​/metadata. . </summary>
		/// <param name="tenantId">	Identifier for the tenant. </param>
		/// <param name="serverId">	Identifier for the server. </param>
		...
		/// <summary>	Gets metadata item details
		/// 			OpenStack API equivalent - > GET/v2/​{tenant_id}​/servers/​{server_id}​/metadata/{key}. . </summary>
		/// <param name="tenantId">	Identifier for the tenant. </param>
		/// <param name="serverId">	Identifier for the server. </param>
		...
		/// <summary>	Updates the metadata item details
		/// 			OpenStack API equivalent PUT/v2/​{tenant_id}​/servers/​{server_id}​/metadata/​{key}​. </summary>
		/// <param name="tenantId">	Identifier for the tenant. </param>
		/// <param name="serverId">	Identifier for the server. </param>
		/// <param name="key">	   	The key. </param>
		/// <returns>	A Task&lt;ServerMetadataResponse&gt; </returns>
		...
		/// <summary>	Deletes the metadata item details
		/// 			OpenStack API equivalent DELETE/v2/​{tenant_id}​/servers/​{server_id}​/metadata/​{key}​. </summary>
		/// <param name="tenantId">	Identifier for the tenant. </param>
		/// <param name="serverId">	Identifier for the server. </param>
		/// <param name="key">	   	The key. </param>
		/// <returns>	A Task&lt;ServerMetadataResponse&gt; </returns>
