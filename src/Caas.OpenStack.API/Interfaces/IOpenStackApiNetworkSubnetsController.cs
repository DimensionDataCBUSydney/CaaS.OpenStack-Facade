// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IOpenStackApiNetworkSubnetsController.cs" company="">
//   
// </copyright>
// <summary>
//   Interface for open stack API network subnets controller.
...
namespace Caas.OpenStack.API.Interfaces
{
	...
	public interface IOpenStackApiNetworkSubnetsController
	{
		...
		/// <summary>
		/// 	Updates the subnet described by subnetId.
		...
		/// <summary>
		/// 	Deletes the subnet described by subnetId.
