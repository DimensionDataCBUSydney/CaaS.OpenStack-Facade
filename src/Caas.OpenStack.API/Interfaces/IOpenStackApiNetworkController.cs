...
namespace Caas.OpenStack.API.Interfaces
{
	...
	public interface IOpenStackApiNetworkController
	{
		...
		/// 			Equivalent -> POST/v2.0/networks </summary>
		...
		/// <summary>	Shows the network.
		/// 			Equivalent -> GET/v2.0/networks/{networkId} </summary>
		...
		/// <summary>	Updates the network. 
		/// 			Equivalent -> PUT/v2.0/networks/{networkId}</summary>
		/// <param name="networkId">	Identifier for the network. </param>
		/// <param name="request">  	The request. </param>
		/// <returns>	A NetworkDetailResponse </returns>
		Task<NetworkDetailResponse> UpdateNetwork(string networkId, NetworkUpdateRequest request);

		/// <summary>	Deletes the network described by networkId.
		/// 			Equivalent -> DELETE/v2.0/networks/{networkId} </summary>
		/// <param name="networkId">	Identifier for the network. </param>
