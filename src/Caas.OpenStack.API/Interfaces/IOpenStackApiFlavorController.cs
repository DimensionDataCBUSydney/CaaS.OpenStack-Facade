// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IOpenStackApiFlavorController.cs" company="">
//   
// </copyright>
// <summary>
//   Interface for open stack API flavour controller.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Caas.OpenStack.API.Interfaces
{
	...
	public interface IOpenStackApiFlavorController
	{
		/// <summary>
		/// 	Gets the flavours. 
		/// 			OpenStack API Equivalent GET/v2/​{tenant_id}​/flavors 
		/// </summary>
		/// <remarks>
		/// 	Anthony, 4/13/2015. 
		/// </remarks>
		...
		/// <summary>
		/// 	Gets flavors details
		/// 			OpenStack API Equivalent GET/v2/​{tenant_id}​/flavors/detail. 
		/// </summary>
		/// <param name="tenantId">
		/// 	Identifier for the tenant. 
		/// </param>
		...
		/// <summary>
		/// 	Gets a flavor.
		/// 			OpenStack API Equivalent GET/v2/​{tenant_id}​/flavors/{flavor_id} 
		/// </summary>
		/// <param name="tenantId">
		/// 	Identifier for the tenant. 
		/// </param>
