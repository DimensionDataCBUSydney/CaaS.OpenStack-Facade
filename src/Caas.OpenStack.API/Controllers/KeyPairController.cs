...
namespace Caas.OpenStack.API.Controllers
{
	...
	{
		/// <summary>	Gets key pairs GET/v2/​{tenant_id}​/os-keypairs. </summary>
		/// <remarks>	Anthony, 4/15/2015. </remarks>
		/// <returns>	The key pairs. </returns>
		...
		/// <summary>	Creates key pair. POST/v2/​{tenant_id}​/os-keypairs. </summary>
		/// <remarks>	Anthony, 4/15/2015. </remarks>
		...
		/// <summary> Deletes the key pair described by keypairName
		/// 		   DELETE/v2/​{tenant_id}​/os-keypairs/​{keypair_name}. </summary>
		/// <remarks>	Anthony, 4/15/2015. </remarks>
		/// <param name="keypairName">	Name of the key pair. </param>
		...
		/// <summary> Updates the key pair described by keypairName 
		/// 		  GET/v2/​{tenant_id}​/os-keypairs/​{keypair_name}. </summary>
		/// <remarks>	Anthony, 4/15/2015. </remarks>
		/// <param name="keypairName">	Name of the key pair. </param>
		/// <returns>	A KeyPairDetailResponse; </returns>
